/*
 ...
 Source Server         : fea-lottery (10.0.0.11)
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', 'Admin', '075eaec83636846f51c152f29b98a2fd', 's4f3', '/assets/img/avatar.png', 'admin@fastadmin.net', 0, 1561456844, 1492186163, 1561456844, '2975a4e7-1dfb-42f6-ae92-589fcd7273eb', 'normal');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '管理员日志表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of admin_log
-- ----------------------------
INSERT INTO `admin_log` VALUES (1, 0, 'Unknown', '/admin/index/login.html', '', '{\"__token__\":\"872c3c0679313e2947e1f884d0ba3afb\",\"username\":\"admin\",\"captcha\":\"G8PW\",\"keeplogin\":\"1\"}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561456834);
INSERT INTO `admin_log` VALUES (2, 1, 'admin', '/admin/index/login.html', '登录', '{\"__token__\":\"ac6fe17ea8471b305591e4cf8accdb92\",\"username\":\"admin\",\"captcha\":\"MVQX\",\"keeplogin\":\"1\"}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561456844);
INSERT INTO `admin_log` VALUES (3, 1, 'admin', '/admin/category/selectpage', '', '{\"searchTable\":\"tbl\",\"searchKey\":\"id\",\"searchValue\":\"12,13\",\"orderBy\":[[\"name\",\"ASC\"]],\"showField\":\"name\",\"keyField\":\"id\",\"keyValue\":\"12,13\",\"searchField\":[\"name\"]}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561544246);
INSERT INTO `admin_log` VALUES (4, 1, 'admin', '/admin/category/selectpage', '', '{\"searchTable\":\"tbl\",\"searchKey\":\"id\",\"searchValue\":\"12\",\"orderBy\":[[\"name\",\"ASC\"]],\"showField\":\"name\",\"keyField\":\"id\",\"keyValue\":\"12\",\"searchField\":[\"name\"]}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561544246);
INSERT INTO `admin_log` VALUES (5, 1, 'admin', '/admin/ajax/upload', '', '{\"name\":\"a70ee061f201db99f27e3ba8f9b38e23.png\"}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561545471);
INSERT INTO `admin_log` VALUES (6, 1, 'admin', '/admin/ajax/upload', '', '{\"name\":\"golang-go-cute-squirrel-baby-programming-mouse-sticker-prints.jpg\"}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561546089);
INSERT INTO `admin_log` VALUES (7, 1, 'admin', '/admin/ajax/upload', '', '{\"name\":\"Cambodia-pic-WEB-min.jpg\"}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561546129);
INSERT INTO `admin_log` VALUES (8, 1, 'admin', '/admin/user/user/edit/ids/1?dialog=1', '会员管理 会员管理 编辑', '{\"dialog\":\"1\",\"row\":{\"group_id\":\"1\",\"username\":\"admin\",\"nickname\":\"admin\",\"password\":\"c13f62012fd6a8fdf06b3452a94430e5\",\"salt\":\"rpR6Bv\",\"email\":\"admin@163.com\",\"mobile\":\"13888888888\",\"avatar\":\"\\/assets\\/img\\/qrcode.png\",\"level\":\"0\",\"gender\":\"0\",\"birthday\":\"2017-04-15\",\"bio\":\"aaaa\",\"money\":\"0.00\",\"score\":\"0\",\"successions\":\"1\",\"maxsuccessions\":\"1\",\"prevtime\":\"2018-01-17 14:28:12\",\"logintime\":\"2018-01-17 14:46:54\",\"loginip\":\"127.0.0.1\",\"loginfailure\":\"0\",\"joinip\":\"127.0.0.1\",\"jointime\":\"2017-04-06 14:50:18\",\"token\":\"aaaaa\",\"status\":\"sss\",\"verification\":\"1224\"},\"ids\":\"1\"}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561546143);
INSERT INTO `admin_log` VALUES (9, 1, 'admin', '/admin/word/add?dialog=1', 'Word 添加', '{\"dialog\":\"1\",\"row\":{\"from\":\"fuck\",\"to\":\"f***\",\"type\":\"replace\"}}', '10.0.2.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36', 1561556742);
...
INSERT INTO `attachment` VALUES (2, 1, 0, '/uploads/20190626/22e722b15d9a5b940131a445fb3020da.png', '100', '100', 'png', 0, 4948, 'image/png', '{\"name\":\"a70ee061f201db99f27e3ba8f9b38e23.png\"}', 1561545471, 1561545471, 1561545471, 'local', 'd98e8f2f24b5a01c01ed015839288ab0f660977d');
INSERT INTO `attachment` VALUES (3, 1, 0, '/uploads/20190626/b88f35e8bedc937ed1f475e8b674ce01.jpg', '1600', '930', 'jpg', 0, 98023, 'image/jpeg', '{\"name\":\"Cambodia-pic-WEB-min.jpg\"}', 1561546129, 1561546129, 1561546129, 'local', 'd0de31f6eb2f888cd7faf7ad37cf7cc9b33ec7fa');
...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '节点表' ROW_FORMAT = Compact;
...
INSERT INTO `auth_rule` VALUES (85, 'file', 0, 'test', '测试管理', 'fa fa-circle-o', '', '', 1, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (86, 'file', 85, 'test/index', '查看', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (87, 'file', 85, 'test/recyclebin', '回收站', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (88, 'file', 85, 'test/add', '添加', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (89, 'file', 85, 'test/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (90, 'file', 85, 'test/del', '删除', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (91, 'file', 85, 'test/destroy', '真实删除', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (92, 'file', 85, 'test/restore', '还原', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (93, 'file', 85, 'test/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1561457315, 1561457315, 0, 'normal');
INSERT INTO `auth_rule` VALUES (94, 'file', 0, 'word', 'Word', 'fa fa-circle-o', '', '', 1, 1561556661, 1561556661, 0, 'normal');
INSERT INTO `auth_rule` VALUES (95, 'file', 94, 'word/index', '查看', 'fa fa-circle-o', '', '', 0, 1561556661, 1561556661, 0, 'normal');
INSERT INTO `auth_rule` VALUES (96, 'file', 94, 'word/add', '添加', 'fa fa-circle-o', '', '', 0, 1561556661, 1561556661, 0, 'normal');
INSERT INTO `auth_rule` VALUES (97, 'file', 94, 'word/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1561556661, 1561556661, 0, 'normal');
INSERT INTO `auth_rule` VALUES (98, 'file', 94, 'word/del', '删除', 'fa fa-circle-o', '', '', 0, 1561556661, 1561556661, 0, 'normal');
INSERT INTO `auth_rule` VALUES (99, 'file', 94, 'word/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1561556661, 1561556661, 0, 'normal');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 1, 'admin', 'admin', 'c13f62012fd6a8fdf06b3452a94430e5', 'rpR6Bv', 'admin@163.com', '13888888888', '/assets/img/qrcode.png', 0, 0, '2017-04-15', 'aaaa', 0.00, 0, 1, 1, 1516170492, 1516171614, '127.0.0.1', 0, '127.0.0.1', 1491461418, 0, 1561546143, 'aaaaa', 'sss', '1224', NULL);
INSERT INTO `user` VALUES (2, 1, 'system', '系统', '', '', 'system@164.com', '', '', 0, 0, NULL, '', 0.00, 0, 1, 1, NULL, NULL, '', 0, '', NULL, NULL, NULL, '', 'none', '', NULL);
...
-- ----------------------------
INSERT INTO `user_statuses` VALUES (12, '5097', 1, 0, '1', '2019-07-06 15:02:46', '2019-07-06 15:02:46', NULL);
...
-- Records of words
-- ----------------------------
INSERT INTO `words` VALUES (1, 'fuck', 'f***', 'replace', 1, NULL, NULL, NULL);
